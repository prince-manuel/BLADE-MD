...
//═══════[Required Variables]════════\\
global.owner = process.env.OWNER_NUMBER || '2349017935543'  // Make SURE its Not Be Empty, Else Bot Stoped And Errors,
...
module.exports = {
  ...
  author:  process.env.PACK_AUTHER ||  '𝓟𝓡𝓘𝓝𝓒𝓔 BOT',
  packname:  process.env.PACK_NAME || 'MADE BY 𝓟𝓡𝓘𝓝𝓒𝓔',
  
  botname:   process.env.BOT_NAME === undefined ? "𝓟𝓡𝓘𝓝𝓒𝓔-MD" : process.env.BOT_NAME,
